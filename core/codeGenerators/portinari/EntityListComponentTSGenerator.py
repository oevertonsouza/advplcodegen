...
class EntityListComponentTSGenerator(codeGenerator):

    def __init__ (self, entity=None):
        super().__init__(entity=None)
        self.templateFile = 'entity-list.component.ts.template'
    ...
    def getVariables(self):
        ...
        for entity in Entity.select():
            optionsVariables = ''
            fields = ''.rjust(2) + "public readonly fields: Array<PoPageDynamicTableField> = [ \n"
